...
/**
 ...
 YYTextLine：它是封装了CTLineRef的对象，
 封装了每一行text的具体展示位置、range、这一行拥有的attachments等等，
 只有一个类方法的初始化方法。如果不了解一些自行描述集的内容，对textLine中的一些属性和操作会不是很清晰
 */
...
@property (nonatomic, readonly) BOOL vertical;      ///< vertical form      垂直形式
...
@property (nonatomic, readonly) CGFloat ascent;     ///< line ascent        上行高度
@property (nonatomic, readonly) CGFloat descent;    ///< line descent       下行高度
@property (nonatomic, readonly) CGFloat leading;    ///< line leading       行间距
