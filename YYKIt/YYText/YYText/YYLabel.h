...
/**
 ...
 @discussion API、行为和UILabel相似，但是YYLabel提供了更多的功能；
 
 * 它支持异步布局和渲染，避免阻塞主线程；
 * 为了更多的文字效果，它继承了CoreText的属性
 * 它允许添加UIImage, UIView and CALayer作为文本的附件；
 * 它提供了指定范围的文本高亮链接，允许用户交互；
 * 它允许添加 container path and exclusion paths 来控制 文本容器形状
 * 它支持竖直方式布局，来显示CJK文本。
 
 See NSAttributedString+YYText.h 提供更过便利方法设置文本属性
 See YYTextAttribute.h and YYTextLayout.h 查看更多信息
 */
